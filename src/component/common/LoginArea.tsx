...
const LogingArea = ({ style }: PropsType) => {
               ...
               <div className="col-xl-6 col-lg-8">
                  <div className="eg-login__wrapper">
                     {style ? (
                        ...
                        <div className="eg-login__top text-center mb-30">
                           <h3 className="eg-login__title">Login to coindox.</h3>
                     ...
                     <div className="eg-login__option">
                        ...
                        <div className="eg-login__social mb-10 ">
                           <div className="eg-login__option-item">
                              <Link to="#"><img src="/assets/img/icon/google.svg" alt="" /> Sign in with google </Link>
                           </div>
                           <div className="eg-login__option-item">
                              <Link to="#">  <img src="/assets/img/icon/facebook.svg" alt="" /> Sign in with facebook </Link>
                           </div>
                        </div>
                     </div>
                  </div>
