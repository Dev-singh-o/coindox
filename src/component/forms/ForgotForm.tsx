                           ...
                           <div className="eg-login__input-wrapper">
                              <div className="eg-login__input-box">
                                 <div className="eg-login__input">
                                    ...
                                    <input id="email" {...register("email")} type="email" placeholder="coindox@mail.com" />
                                    <p className="form_error">{errors.email?.message}</p>
                                 </div>
                              </div>
                           </div>
                           <div className="eg-login__bottom mt-30">
                              <button type="submit" className="thm-btn w-100">Send Mail</button>
                           </div>
                           <p className="forgot">Remeber Passowrd? <Link to="/login">Login</Link></p>
                        </div>
                     </form>
                  </div>
               </div>
