            ...
            <div className="blog-single__wrap">
              <div className="blog-single__top">
                ...
                <ul className="blog__meta ul_li mb-30">
                  <li><Link to="#"><i className="far fa-user"></i>{single_blog?.user ? single_blog.user : "Liam James"}</Link></li>
                  <li><i className="far fa-clock"></i>Dec 28, 2022</li>
                  <li><Link to="#"><i className="far fa-comment"></i>(04) Coments</Link></li>
                </ul>
              </div>
              <div className="blog-single__thumb">
                {single_blog?.thumb ? <img src={single_blog.thumb} alt="image" /> : <img src="/assets/img/blog/img_05.jpg" alt="image" />}
              </div>
